...
#first call the libraries needed for the following code. Using read.delim() will read the data based on the selected seperator,  which in this case is a pipe symbol
